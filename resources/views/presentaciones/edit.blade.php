...
@yield('title', 'Editar presentacion')
@push('css')
...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Editar Presentacion</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item" ><a href="{{route('panel')}}">Inicio</a></li>
        <li class="breadcrumb-item"><a href="{{route('presentacion.index')}}">Presentaciones</a></li>
